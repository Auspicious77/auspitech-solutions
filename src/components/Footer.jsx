        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-wrap gap-2">
              <a href="https://instagram.com/auspitech_solution" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-cobalt transition-colors" aria-label="Instagram">
                <InstagramIcon size={16} />
              </a>
              <a href="https://www.facebook.com/AuspitechSolutions" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-cobalt transition-colors" aria-label="Facebook">
                <FacebookIcon size={16} />
              </a>
              <a href="https://x.com/AuspitechSolution" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-cobalt transition-colors" aria-label="Twitter / X">
                <XIcon size={16} />
              </a>
              <a href="https://tiktok.com/@auspitechsolution" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-cobalt transition-colors" aria-label="TikTok">
                <TikTokIcon size={16} />
              </a>
              <a href="https://www.linkedin.com/company/auspitech-solution/about/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-cobalt transition-colors" aria-label="LinkedIn">
                <LinkedinIcon size={16} />
              </a>
              <a href="https://wa.me/2348148645867" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#25D366] transition-colors" aria-label="WhatsApp">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+2348148645867" className="text-warm-white/60 hover:text-cobalt text-sm font-body transition-colors">
                  +234 814 864 5867
                </a>
              </li>
            </ul>
